...
8.	- JSON es un formato de datos basado en texto que sigue la sintaxis de objeto de JavaScript.
	  ...
	  ![JsonExample](https://user-images.githubusercontent.com/119004729/204362320-a5ebdb38-ff07-44b3-b94b-5b4cab224bee.png)
	...
	- XML es un formato de texto que se utiliza para almacenar e intercambiar datos estructurados, bien sea que se trate de documentos, configuraciones,           transacciones o simplemente datos.
	  ...
	  ![XmlExample](https://user-images.githubusercontent.com/119004729/204362359-7e606e07-fe06-4dc1-9b2c-8374d05b19a3.png)
...
Pueden ver mi perfil de Salesforce [aquí](https://trailblazer.me/id/rbeccari).

![Trailhead](https://user-images.githubusercontent.com/119004729/204355308-cb5f92d0-f26c-4c57-941b-e584a511e48c.jpg)
___________________________________________________________________________
...
- A- SaaS: El software como servicio, es un modelo de entrega de software basado en la nube en el que el proveedor de la nube desarrolla y mantiene el software de las aplicaciones en la nube, proporciona actualizaciones automáticas del mismo y lo pone a disposición de sus clientes a través de Internet con un sistema de pago por uso.

- B- No, Salesforce es una compañía de PaaS (Plataforma como Servicio), un concepto que nace como resultado de la aplicación al desarrollo de Software del modelo SaaS.

- C- Una solucion Cloud es un software o plataforma que ayuda a las empresas a administrar sus datos y aplicaciones mediante el uso de una infraestructura basada en la nube.

- D- On-Premise se refiere al hecho que los titulares de la licencia instalan el software en su propio entorno informático, sin recurrir a la nube o necesitar acceso a internet.

- E- Un pipeline de ventas se refiere a cada paso en su procedimiento de ventas que toma un representante para llevar un acuerdo de principio a fin.

- F- El funnel de ventas es una representación gráfica de las etapas por las que pasa un usuario para convertirse en cliente de una marca.

- G- El Customer Experience es cómo se relaciona una empresa con sus clientes en todos los aspectos del recorrido de compra, desde el marketing hasta las ventas y el servicio al cliente pasando por cada punto intermedio.

- H- La omnicanalidad es una estrategia de comunicación utilizada para estar en contacto con los prospectos o clientes a través de diferentes canales (email, redes sociales, sitio web, etc.).

- I- El B2B es un modelo de negocio que consiste en los servicios que una compañía entrega a otra con el objetivo de mejorar las ventas de los productos y bienes que ofrece. Por otro lado, un negocio B2C se refiere a la actividad comercial entre un negocio y un consumidor individual.
     El KPI (Key Performance Indicator) es un sistema de medición que, expresado normalmente en un porcentaje, nos dice el grado de progreso o cumplimiento de un objetivo de la empresa.

- J- Una API es un conjunto de definiciones y protocolos que se utiliza para desarrollar e integrar el software de las aplicaciones. A diferencia de una API Rest que es un estilo arquitectónico que utiliza implementaciones cliente-servidor de forma independiente utilizando el protocolo HTTP para la comunicación.

- K- Un proceso batch es la ejecución de una serie de operaciones manuales y automáticas mediante la cual los fabricantes pueden llevar adelante sus recetas de producción.

- L- Kanban es un método de gestión del flujo de trabajo que ayuda a las organizaciones a gestionar y mejorar los sistemas de trabajo.

- M- ERP (Enterprise Resource Planning) se refiere al software y los sistemas utilizados para planificar y administrar todos los procesos clave de la cadena de suministro, la manufactura, los servicios, las finanzas y otros procesos de una organización.

- N- Salesforce no es un ERP. Salesforce ofrece varias soluciones comerciales, que pueden integrarse para mejorar y respaldar su ERP, pero no proporciona un producto ERP.
___________________________________________________________________________
